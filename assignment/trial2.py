...
def run_individual() -> None:
    ...
    # Simulate the robot
    ctrl = Controller(
        controller_callback_function=neuro_controller,
...
def run_evolution(label, generations=200, sloped=False, smart=True):
    eval_func = run_individual

    problem = NEProblem(
        network=lambda: GeckoPolicy(),
...
if __name__ == '__main__':
    run_evolution('test',generations=5)